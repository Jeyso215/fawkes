...
def test(num_identities, val = False):
    ...
    for identity_pair in identity_pairs:
        ...
        if val:
            ...
            img_scorer.score_images(source_img_path, f"verilight_tests/{source_name}2{target_name}/cloaked_source.jpg", target_img_path, og_references=other_source_imgs)
